...
return [
    ...
    'alpha_dash'           => ':attribute 只能以字母、數字、連字號(-)及底線(_)組成。',
    'alpha_num'            => ':attribute 只能以字母及數字組成。',
    'latin'                => ':attribute 只能以 ISO 標準拉丁字母組成。',
    'latin_dash_space'     => ':attribute 可能只包含 ISO 標準拉丁字母、數字、破折號、連字號和空格。',
    ...
    'dont_allow_first_letter_number' => '\":input\" 欄第一個字母不能是數字。',
    'exceeds_maximum_number'         => ':attribute 超過模型最大長度。',
    'db_column'                      => ':attribute 只能包含 ISO 標準拉丁字母、數字、破折號，不能以數字開頭。',
    'attributes'                     => [
        'address'               => '地址',
        'age'                   => '年齡',
        'available'             => '可用的',
